...
async function loadItems() {
    ...
    items.forEach(element => {
        ...
        body+=`
        <div class="col-lg-4">
            <img  src="${element.flags.png}" alt="" class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="var(--bs-secondary-color)">
          <h2 class="fw-normal">${element.continents}</h2>
          <p>${element.altSpellings}</p>
          
          <p><a class="btn btn-secondary" href="${element.maps.googleMaps}">View Location &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
